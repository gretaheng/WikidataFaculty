...
def dataPrep(basePath, deptfolder, filename, fileExtention, fieldQnum, departmentQnum, websiteBaseUrl, allOnePage):
    ...
    for i, r in df.iterrows():
        ...
        df1.to_csv(basePath + deptfolder + filename + "_ready4or" + fileExtention, encoding="utf8")
...
if __name__ == '__main__':
    ...
    dataPrep(basePath, deptfolder, filename, fileExtention, fieldQnum, departmentQnum, websiteBaseUrl, allOnePage)
