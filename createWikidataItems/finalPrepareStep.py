...
def createWikidataItems():
    typeOfFaculty = str(input("\nEnter \'t\' for Tenure or \'e\' for Emeritus: "))

    source = str(input("Enter source file with full path: "))

    destination = str(input("Enter destination file with full path: "))
    ...
    print("\nSUCCESS: File save at ", destination)
